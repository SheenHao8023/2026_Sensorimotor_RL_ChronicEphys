...
for k=1:length(Datapath)
    ...
    for probe=1:2
        for shank=1
            ...
            suapath = [suapath_root, '\Kilosort_SingleUnits', num2str(probe), '\'];  % shank体现在后段文件名中
...
session_dir = {
    'C:\Users\XinHao\Desktop\CIBRZY25\';...
     };
...
probetype=2; %1 CB64; 2 NP1.0 or NP2.0
...
% single_unit_dir='C:\Users\XinHao\Desktop\CIBRZY25\Kilosort_SingleUnits1\';
% combine_pairs={
%    };

single_unit_dir='C:\Users\XinHao\Desktop\CIBRZY25\Kilosort_SingleUnits2\';
combine_pairs={
   };
